...
/**
 * Performs a default action for source code within a project.
 * @author Katsuhisa Maruyama
 */
public class JtoolHandler extends AbstractHandler {
    
    static Logger logger = Logger.getLogger(JtoolHandler.class.getName());
